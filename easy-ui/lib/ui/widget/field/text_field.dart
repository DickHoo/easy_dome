...
extension TextFieldEX on TextField {
  ...
  TextField setFontFamily(String family) {
    ...
    return textFieldEntrance(style: style?.merge(newStyle) ?? newStyle);
  }
  ...
  TextField setHintFamily(String family) {
    ...
    return textFieldEntrance(decoration: decoration?.copyWith(hintStyle: mergeStyle));
  }
  ...
  TextField setHintText(String hint) {
    return textFieldEntrance(decoration: decoration?.copyWith(hintText: hint));
  }

  ///最大长度
  TextField setMaxLength(int len) {
    return textFieldEntrance(maxLength: len);
  }

  ///接收什么类型数据
  TextField setKeyboardType(TextInputType textInputType) {
    return textFieldEntrance(keyboardType: textInputType);
  }

  ///设置边框
  TextField setBorder(InputBorder border) {
    return textFieldEntrance(decoration: decoration?.copyWith(border: border));
  }
